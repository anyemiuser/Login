...
public class SSLConection {
    ...
    public static void allowAllSSL(Context mContext, String methodname, String URL1) {
        ...
        try {
            ...
            PrintLog.print("allowAllSSL", var22.toString());
        } catch (KeyManagementException var23) {
           PrintLog.print("allowAllSSL", var23.toString());
        } catch (CertificateException var24) {
           PrintLog.print("Exception = ", "" + var24.toString());
        } catch (KeyStoreException var25) {
           PrintLog.print("Exception = ", "" + var25.toString());
        } catch (IOException var26) {
           PrintLog.print("Exception = ", "" + var26.toString());
        }
